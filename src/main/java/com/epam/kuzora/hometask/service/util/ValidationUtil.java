...
import com.epam.kuzora.hometask.service.constant.ServiceConstant.Validation;
...
public class ValidationUtil {
    ...
    public static void validateJson(File schemaFile, String jsonFile) throws IOException, ProcessingException {
        final JsonSchema schemaNode = getSchemaNode(schemaFile);
        final JsonNode jsonNode = getJsonNode(jsonFile);
        validateJson(schemaNode, jsonNode);
    }
    ...
    public static JsonSchema _getSchemaNode(JsonNode jsonNode) throws ProcessingException {
        final JsonNode schemaIdentifier = jsonNode.get(Validation.JSON_SCHEMA_IDENTIFIER_ELEMENT);
        if (null == schemaIdentifier) {
            ((ObjectNode) jsonNode).put(Validation.JSON_SCHEMA_IDENTIFIER_ELEMENT,
                Validation.JSON_V4_SCHEMA_IDENTIFIER);
        }
